...
CI tests Swift 6.2.4 with Xcode 16.4 and Swift 6.3.3 with Xcode 26.3. Formatting, dependency-fixture and universal-packaging checks run once on the minimum-toolchain job. The repository's CodeQL workflow builds Swift sources and tests directly and also scans Python and Actions; it replaces GitHub's default setup.
